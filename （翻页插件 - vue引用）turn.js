...
export default (function (A) {
  ...
  var has3d,
    ...
    turnMethods = {
      ...
      init: function (options) {
        ...
        data.eventHandlers = {
          touchStart: A.proxy(turnMethods._touchStart, this),
          touchMove: A.proxy(turnMethods._touchMove, this),
          touchEnd: A.proxy(turnMethods._touchEnd, this),
          start: A.proxy(turnMethods._eventStart, this),
        }
        ...
        A(this).parent().bind("start", data.eventHandlers.start)
      ...
      addPage: function (element, page) {
        ...
        if ((currentPage = /\bp([0-9]+)\b/.exec(A(element).attr("class"))))
      ...
      destroy: function () {
        ...
        A.each(events, function (index, eventName) {
      ...
      zoom: function (newZoom) {
        ...
        if (typeof newZoom == "number") {
          ...
          A(this).turn("stop").turn("size", newWidth, newHeight)
          /*.
        css({marginTop: size.height * iz / 2 - newHeight / 2})*/

          if (data.opts.autoCenter) this.turn("center")
          /*else
        A(this).css({marginLeft: size.width * iz / 2 - newWidth / 2})*/
      ...
      display: function (display) {
        ...
        if (display === undefined) {
          ...
          if (A.inArray(display, displays) == -1)
          ...
          switch (display) {
            case "single":
              ...
              if (!data.pageObjs[0]) {
                ...
                data.pageObjs[0] = A("<div />", { class: "page p-temporal" })
      ...
      direction: function (dir) {
        ...
        if (dir === undefined) {
          ...
          if (A.inArray(dir, directions) == -1)
            throw turnError('"' + dir + '" is not a value for direction')

          if (dir == "rtl") {
            A(this).attr("dir", "ltr").css({ direction: "ltr" })
          }

          data.direction = dir

          if (data.done) this.turn("size", A(this).width(), A(this).height())
        ...
        for (page in data.pages) {
          if (has(page, data.pages))
            data.pages[page].flip(
              "disable",
              data.disabled ? true : A.inArray(parseInt(page, 10), view) == -1
            )
        }
      ...
      _turnPage: function (page) {
        ...
        if (data.page != page) {
          ...
          if (trigger("turning", this, [page, newView]) == "prevented") {
            if (currentPage == data.page && A.inArray(place, data.pageMv) != -1)
              data.pages[place].flip("hideFoldedPage", true)

            return
          }

          if (A.inArray(1, newView) != -1) this.trigger("first")
          if (A.inArray(data.totalPages, newView) != -1) this.trigger("last")
        }
        ...
        if (page === undefined) {
          ...
          if (!data.disabled && !data.destroying) {
            ...
            if (page > 0 && page <= data.totalPages) {
              if (page != data.page) {
                if (!data.done || A.inArray(page, this.turn("view")) != -1)
      ...
      _flip: function (e) {
        ...
        var opts = A(e.target).data().f.opts
            ...
            if ((p = data.pages[page])) {
              ...
              if (data.tpage) {
                ...
                p.flip("hover", false).flip(
                  "disable",
                  A.inArray(parseInt(page, 10), data.pageMv) == -1 &&
                    page != newView[0] &&
                    page != newView[1]
                )
              } else {
    ...
    flipMethods = {
      ...
      options: function (opts) {
        ...
        if (opts) {
          flipMethods.setData.call(this, {
            opts: A.extend({}, data.opts || flipOptions, opts),
          })
          return this
      ...
      _cornerActivated: function (p) {
        ...
        return !point.corner || A.inArray(point.corner, allowedCorners) == -1
          ? false
          : point
      },
      ...
      _backGradient: function () {
        ...
        if (gradient && !data.bshadow)
          data.bshadow = A("<div/>", divAtt(0, 0, 1))
        ...
        if (!data.wrapper)
          switch (data.effect) {
            case "hard":
              ...
              data.wrapper = A("<div/>", divAtt(0, 0, 2))
                .css(cssProperties)
                .appendTo(parent)
                .prepend(this)

              data.fpage = A("<div/>", divAtt(0, 0, 1))
                .css(cssProperties)
                .appendTo(parent)

              if (turnData.opts.gradients) {
                data.ashadow = A("<div/>", divAtt(0, 0, 0))
                  .hide()
                  .appendTo(parent)

                data.bshadow = A("<div/>", divAtt(0, 0, 0))
              }
            ...
            case "sheet":
              ...
              data.wrapper = A("<div/>", divAtt(0, 0, this.css("z-index")))
                .appendTo(parent)
                .prepend(this)
              ...
              data.fpage = A("<div/>", divAtt(0, 0, 0, "visible"))
                .css({ cursor: "default" })
                .appendTo(data.fwrapper)

              if (turnData.opts.gradients)
                data.ashadow = A("<div/>", divAtt(0, 0, 1)).appendTo(
                  data.fpage
                )
      ...
      peel: function (corner, animate) {
        ...
        if (corner) {
          if (A.inArray(corner, corners.all) == -1)
            throw turnError("Corner " + corner + " is not permitted")

          if (A.inArray(corner, flipMethods._cAllowed.call(this)) != -1) {
  ...
  A.extend(A.fn, {
    flip: function () {
      return dec(A(this[0]), flipMethods, arguments)
    },

    turn: function () {
      return dec(A(this[0]), turnMethods, arguments)
    },
  ...
  A.isTouch = isTouch
  A.mouseEvents = mouseEvents
  A.cssPrefix = getPrefix
  A.cssTransitionEnd = getTransitionEnd
  A.findPos = findPos
})(jquery)
